...
/**
 * A <code>ParamPart</code> is an upload part which represents a normal <code>INPUT</code> (for example a non <code>TYPE="file"</code>) form parameter.
 * @author  Geoff Soutter
 * @author  Jason Hunter
 * @version  1.1, 2002/04/30, added better encoding support, thanks to  Changshin Lee
...
public class ParamPart extends Part {
   ...
   * value.
   */
  public ParamPart(String name, ServletInputStream in,
            String boundary) throws IOException {
    this(name, in, boundary, null);
  }
 ...
 */
  ...
  public String getStringValue(String encoding) throws UnsupportedEncodingException {
    return (encoding!=null) ? new String(value, encoding) : new String(value);
  }
