//http://www.porcupyne.org/docs/browse_source/JavaServlet/com/oreilly/servlet/MultipartRequest.java.html
...
import framework.ressource.upload.FilePart;
import framework.ressource.upload.MultipartParser;
import framework.ressource.upload.ParamPart;
import framework.ressource.upload.Part;
...
public class UtilFileUpload {
   ...
   */
  public UtilFileUpload(HttpServletRequest request, String saveDirectory) throws IOException {
   ...
   */
  public UtilFileUpload(HttpServletRequest request, String saveDirectory, int maxPostSize) throws IOException {
    // Sanity check values
    if (request == null)
   ...
   *
   */
  public UtilFileUpload(ServletRequest request, String saveDirectory) throws IOException {
   ...
   *
   */
  public UtilFileUpload(ServletRequest request, String saveDirectory, int maxPostSize) throws IOException {
